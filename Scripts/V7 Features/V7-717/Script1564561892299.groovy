...
WebUI.click(findTestObject('Page_BusinessRadar-Client 700/Span/span_KAMPAGNENDEFINITION'))

WebUI.verifyElementVisible(findTestObject('Page_BusinessRadar-Client 700/Div/div_Kampagne erstellen  Kampagne modifizieren'))
